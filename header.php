...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'pawsgangc'); ?></a>
					...
					<div class="col-md-4">
						<ul class="announcement-bar__list">
							<li>
								...
								<a href="tel: 353879352721" class="text-decoration-none">087 935 27 21</a>
							</li>
							<li>
								<i class="bi bi-envelope rounded-circle"></i>
								<a href="mailto:conorwalsh0703@gmail.com" class="text-decoration-none">conorwalsh0703@gmail.com</a>
							</li>
						</ul>
					</div>
					...
					<div class="row">
						<div class="col-12 d-flex justify-content-center">
							<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
								...
								<?php esc_html_e('Primary Menu', 'pawsgangc'); ?>
							</button>
						</div>
